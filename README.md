...
| -------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **5.c1. Trabaja en equipo para proporcionar liderazgo en forma conjunta**                                | **Julio Frank Quispe Serrano:**<br>**AV1:** Participé en la elaboración del Startup Profile y apoyé la coordinación de las primeras actividades del equipo.<br>**TB1:** Lideré la explicación de la arquitectura base de la WebApp, detallando el funcionamiento del Shared Kernel y del módulo de notificaciones.<br>**AV2:** Colaboré en la adaptación de los diagramas de clases para que reflejaran correctamente la implementación del backend.<br>**TB2:** Lideré el levantamiento de observaciones del informe, actualicé la documentación del modelo de base de datos e implementé la capa de aplicación del bounded context IAM.<br><br>**José Zacarías Ortega Quintana:**<br>**AV1:** Participé en la organización y ejecución de entrevistas, así como en el análisis competitivo.<br>**TB1:** Lideré la explicación de la gestión de perfiles y asignaciones en el módulo Stakeholder.<br>**AV2:** Realicé la evaluación heurística de la aplicación y comuniqué al equipo las oportunidades de mejora identificadas.<br>**TB2:** Asumí el liderazgo técnico de la capa de presentación de IAM, implementando endpoints REST, resources y assemblers.<br><br>**Mathias Marcelo De La Cruz De Los Santos:**<br>**AV1:** Apoyé la definición visual del Landing Page y la coherencia de la propuesta gráfica.<br>**TB1:** Lideré la sustentación de los flujos de autenticación mediante JWT y de los planes de suscripción.<br>**AV2:** Desarrollé y presenté el apartado *About the Product*.<br>**TB2:** Lideré la implementación del dominio de IAM, modelando value objects y errores del dominio. También produje el video *About-the-Product*, encargándome de la grabación, edición y branding.<br><br>**Fabio Cesar Vallejo Trujillo:**<br>**AV1:** Participé en las decisiones técnicas iniciales y en la organización del diseño del producto.<br>**TB1:** Lideré la sustentación del módulo de planificación logística, explicando el trazado de rutas, la gestión de paradas y la administración de flota.<br>**AV2:** Lideré el despliegue de la mayoría de los servicios y su integración con la Web Application.<br>**TB2:** Asumí el liderazgo técnico de la infraestructura de IAM, implementando BCrypt, tokens JWT y persistencia con EF Core. También lideré la fidelización de los diagramas respecto al backend y el redespliegue de la solución.<br><br>**Nickolas Ramirez Ruiz:**<br>**AV1:** Coordiné la planificación del Sprint 1 y la distribución inicial de tareas.<br>**TB1:** Lideré la presentación de la ejecución operativa, el monitor en tiempo real y el proceso de abordaje de estudiantes.<br>**AV2:** Coordiné la planificación y el seguimiento del Sprint 3.<br>**TB2:** Coordiné el Sprint 4, organicé sus evidencias y lideré las entrevistas de validación. Además, asumí el liderazgo del modelado de aggregates, commands y queries de IAM.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | **AV1:** El equipo distribuyó el liderazgo desde el inicio, permitiendo que distintos integrantes asumieran responsabilidades sobre investigación, diseño, planificación y decisiones técnicas.<br><br>**TB1:** Cada integrante lideró la sustentación de un módulo o flujo específico de SafeRoute, logrando una exposición conjunta y coherente de la arquitectura y del funcionamiento de la solución.<br><br>**AV2:** El liderazgo se compartió entre actividades técnicas y de documentación, incluyendo coordinación del Sprint, evaluación heurística, actualización de diagramas, despliegue y elaboración de contenidos audiovisuales.<br><br>**TB2:** La implementación del bounded context IAM se distribuyó por capas, permitiendo que cada integrante liderara una parte concreta. En paralelo, se asumieron responsabilidades de coordinación, validación, despliegue, documentación y producción audiovisual, evidenciando liderazgo conjunto.                                                                                                                                                                                                                                                                                                         |
| **5.c2. Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos** | **Julio Frank Quispe Serrano:**<br>**AV1:** Colaboré con el equipo en la definición del Startup Profile, coordinando información y aportes para cumplir con los objetivos iniciales del proyecto.<br>**TB1:** Trabajé con los responsables de los demás módulos para integrar la arquitectura base y mantener coherencia entre el Shared Kernel, las notificaciones y los demás bounded contexts.<br>**AV2:** Coordiné con el equipo la actualización de los diagramas de clases y su adaptación al backend implementado.<br>**TB2:** Colaboré en la corrección de observaciones, la actualización del modelo de base de datos, la implementación de IAM y las entrevistas de validación, cumpliendo con las tareas asignadas en el Sprint.<br><br>**José Zacarías Ortega Quintana:**<br>**AV1:** Participé en la planificación y ejecución de entrevistas, compartiendo hallazgos con el equipo para fortalecer la investigación del producto.<br>**TB1:** Coordiné la explicación del módulo Stakeholder con los demás responsables, asegurando que los flujos de perfiles y asignaciones fueran consistentes con la solución general.<br>**AV2:** Colaboré en el desarrollo del backend y realicé la evaluación heurística, comunicando los hallazgos para convertirlos en mejoras concretas.<br>**TB2:** Coordiné la implementación de los endpoints de IAM con las capas de dominio, aplicación e infraestructura, y actualicé los artefactos de Lean UX según las observaciones recibidas.<br><br>**Mathias Marcelo De La Cruz De Los Santos:**<br>**AV1:** Trabajé con el equipo en el diseño del Landing Page, manteniendo una propuesta visual coherente con los objetivos y segmentos del producto.<br>**TB1:** Coordiné con los responsables técnicos la explicación de los flujos de autenticación y suscripción, integrándolos con los demás módulos de SafeRoute.<br>**AV2:** Colaboré en el backend y elaboré las secciones *About the Product* y *About the Team*, cumpliendo con las tareas de comunicación del Sprint.<br>**TB2:** Coordiné la integración de los componentes de dominio de IAM y cumplí con la producción del video *About-the-Product* dentro del plazo definido por el equipo.<br><br>**Fabio Cesar Vallejo Trujillo:**<br>**AV1:** Colaboré en la planificación técnica y en la estructuración del diseño del producto, coordinando decisiones con los demás integrantes.<br>**TB1:** Trabajé con el equipo para integrar el módulo de planificación logística con los flujos de viajes, conductores, vehículos y rutas.<br>**AV2:** Colaboré en el desarrollo del backend, el despliegue de servicios y la conexión con el frontend, verificando que los componentes funcionaran correctamente en el entorno desplegado.<br>**TB2:** Coordiné la implementación de la infraestructura de IAM con las demás capas, actualicé los diagramas para que reflejaran el backend real y realicé el redespliegue de la solución con el nuevo contexto integrado.<br><br>**Nickolas Ramirez Ruiz:**<br>**AV1:** Organicé las tareas del Sprint 1, asigné responsables y realicé seguimiento al cumplimiento de los objetivos iniciales.<br>**TB1:** Coordiné con el equipo la preparación de la sustentación y la integración de los flujos operativos de monitoreo y abordaje.<br>**AV2:** Planifiqué y realicé seguimiento al Sprint 3, promoviendo la participación de todos los integrantes en las tareas técnicas y documentales.<br>**TB2:** Organicé las tareas y evidencias del Sprint 4, coordiné las entrevistas de validación y trabajé con las demás capas de IAM para completar la implementación del bounded context. | **AV1:** El equipo creó un entorno colaborativo mediante la distribución de tareas de investigación, diseño y planificación. Se establecieron metas iniciales y cada integrante cumplió con las responsabilidades asignadas para definir la propuesta de SafeRoute.<br><br>**TB1:** El trabajo se organizó por módulos y bounded contexts, lo que permitió que cada integrante desarrollara y sustentara una parte de la solución. La coordinación entre responsables permitió cumplir con los objetivos técnicos y documentales del entregable.<br><br>**AV2:** El equipo planificó el Sprint 3 distribuyendo actividades de backend, evaluación heurística, actualización de diagramas, despliegue y elaboración de contenidos audiovisuales. Las tareas se desarrollaron de manera coordinada y las observaciones recibidas se transformaron en mejoras concretas.<br><br>**TB2:** El equipo dividió la implementación de IAM por capas de dominio, aplicación, infraestructura y presentación. Esta planificación permitió integrar los aportes de todos los integrantes, corregir las observaciones anteriores, actualizar los artefactos, redesplegar la solución y completar las entrevistas de validación, cumpliendo con los objetivos finales del proyecto. |
...
> _Captura de pantalla de la entrevista realizada al segmento Padre de Familia._
...
_El listado completo de commits del Sprint 2 se encuentra disponible en los repositorios oficiales del equipo en GitHub._
...
**Enlace al video:** _(https://www.youtube.com/watch?v=R2t3VSuSEVI)_
...
El video _About-The-Team_ presenta el proceso de trabajo realizado por el equipo PowerTech durante el desarrollo de **SafeRoute**, una plataforma orientada a mejorar la seguridad y gestión del transporte escolar.
...
| 00:05:21 | Resumen general del proyecto SafeRoute | Descripción del proceso integral del proyecto: investigación de usuarios, definición de requerimientos mediante User Stories e Impact Mapping, diseño UX/UI, arquitectura basada en Domain-Driven Design, implementación ágil y despliegue en Microsoft Azure. |
| 00:06:43 | Logros y competencias alcanzadas | Reflexión sobre el fortalecimiento de habilidades de comunicación técnica y de negocio, documentación colaborativa, estandarización de procesos, trabajo en equipo y capacidad para sustentar decisiones de arquitectura, implementación y despliegue. |
| 00:07:16 | Cierre | Conclusiones finales sobre SafeRoute como solución tecnológica para la seguridad en el transporte escolar y evidencia del crecimiento profesional, organizacional y comunicativo del equipo PowerTech. |
...
- Gothelf, J. (2021, June 28). *How to use the Lean UX Canvas*. Jeff Gothelf. Recuperado el 8 de julio de 2026, de https://jeffgothelf.com/blog/how-to-use-the-lean-ux-canvas/
